...
export const projects: Project[] = [
  ...
  {
    id: "barcode-print-automation",
    title: "Barcode Print Automation Desktop Application",
    tagline:
      "Enterprise barcode label printing automation with BarTender integration",
    description:
      "A lightweight desktop application built with Tauri that automates barcode label printing by connecting cloud product data with local thermal printers.",
    longDescription:
      "This desktop application was developed to streamline and automate enterprise barcode label printing workflows. Built using Tauri for high performance and low resource usage, the system securely connects cloud-based product data from a Laravel API with local thermal printing hardware.\n\nThe application integrates with the BarTender print engine to trigger automated label printing. It provides secure authentication, fast barcode lookup, and real-time printing operations, making it suitable for inventory, logistics, and production labeling environments.\n\nBy eliminating manual steps in the barcode printing workflow, the system significantly improves operational efficiency while reducing human error in label generation and printing processes.",
    ...
    accentColor: "#00f0ff",
    highlights: [
      "Built a lightweight cross-platform desktop application using Tauri",
      "Implemented secure authentication for controlled printing access",
      "Integrated BarTender automation for label printing workflows",
      "Connected Laravel REST APIs with local printing infrastructure",
      "Reduced manual printing processes and minimized human error",
    ],
    media: [
      {
        type: "image",
