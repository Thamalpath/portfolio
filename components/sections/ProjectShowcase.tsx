    ...
    >
      <div className="relative z-10 flex flex-col gap-4 md:gap-6">
        ...
        <div className="flex gap-4">
          <Twitch size={18} className="text-[#9146ff] cursor-pointer hover:scale-110 transition-transform md:w-6 md:h-6" />
          <Instagram size={18} className="text-pink-500 cursor-pointer hover:scale-110 transition-transform md:w-6 md:h-6" />
        </div>
      </div>
